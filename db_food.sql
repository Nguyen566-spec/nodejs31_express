...
CREATE TABLE `like_res` (
  ...
  PRIMARY KEY (`like_id`),
  KEY `like_res_ibfk_1` (`user_id`),
  KEY `like_res_ibfk_2` (`res_id`),
...
CREATE TABLE `rate_res` (
  ...
  PRIMARY KEY (`rate_id`),
  KEY `rate_res_ibfk_1` (`user_id`),
  KEY `rate_res_ibfk_2` (`res_id`),
...
INSERT INTO `like_res` (`like_id`, `user_id`, `res_id`, `date_like`) VALUES
(2, 1, 2, '2022-01-01 09:00:00');
INSERT INTO `like_res` (`like_id`, `user_id`, `res_id`, `date_like`) VALUES
(3, 1, 3, '2022-01-01 09:00:00');
INSERT INTO `like_res` (`like_id`, `user_id`, `res_id`, `date_like`) VALUES
(4, 2, 2, '2022-01-01 09:00:00'),
(5, 2, 3, '2022-01-01 09:00:00'),
(6, 3, 1, '2022-01-01 09:00:00');
...
(1, 1, 2, 4, '2022-01-01 09:00:00');
INSERT INTO `rate_res` (`rate_id`, `user_id`, `res_id`, `amount`, `date_rate`) VALUES
(2, 1, 3, 5, '2022-01-01 09:00:00');
INSERT INTO `rate_res` (`rate_id`, `user_id`, `res_id`, `amount`, `date_rate`) VALUES
(3, 2, 1, 3, '2022-01-01 09:00:00');
INSERT INTO `rate_res` (`rate_id`, `user_id`, `res_id`, `amount`, `date_rate`) VALUES
(4, 2, 3, 3, '2022-01-01 09:00:00');
